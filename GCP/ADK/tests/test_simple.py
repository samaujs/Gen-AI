...
def selectbox_mock(label, options, **kwargs):
    if 'Agent Workflow' in label:
        return 'google-adk-workflows/simple'
...
def run_nz_query():
    ...
    print(f"Executing query on simple agent:\n{prompt}\n")
    print("=" * 80)
    ...
    output_log_path = Path("/Users/samaujs/.gemini/antigravity/brain/2e7e63e3-72f0-4aa5-94c2-d1e489ae71e3/scratch/simple_observability_trace.txt")
