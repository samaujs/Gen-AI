...
judge = Agent(
    ...
    # This forces the Judge to only return the structured JudgeFeedback. It cannot decide to "chat" 
    # with the user or delegate to another agent. This makes it a deterministic component in our logic flow.
)
